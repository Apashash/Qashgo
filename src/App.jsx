...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-700 via-sky-800 to-sky-900 pattern-bg text-white">
      {/* Header */}
      <header className="glass-effect border-b border-sky-300/20">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-sky-300">SUPEREARN AGENCIE</h1>
            <div className="flex items-center space-x-2">
              ...
              <Button
                ...
                className="px-4 py-2 text-sm font-medium bg-sky-500/20 hover:bg-sky-500/30 transition-colors rounded-lg"
              >
                {t('login')}
              </Button>
              <Button
                onClick={() => navigate('/register')}
                className="px-4 py-2 text-sm font-medium bg-gradient-to-r from-green-500 to-sky-500 hover:from-green-600 hover:to-sky-600 transition-colors rounded-lg"
              >
                {t('register')}
              </Button>
            </div>
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-sky-400 to-red-400 mb-6">
            {t('landingTitle')}
          </h1>
          <p className="text-xl text-sky-100/80 mb-8 max-w-2xl mx-auto">
            {t('landingSubtitle')}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button
              onClick={() => navigate('/register')}
              className="px-8 py-4 text-lg font-semibold bg-gradient-to-r from-green-500 to-sky-500 hover:from-green-600 hover:to-sky-600 transition-colors rounded-lg"
            >
              {t('getStarted')}
            </Button>
            <Button
              onClick={() => navigate('/login')}
              className="px-8 py-4 text-lg font-semibold bg-sky-500/20 hover:bg-sky-500/30 transition-colors rounded-lg"
            >
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            <motion.div
              ...
              className="glass-effect p-6 rounded-lg border border-sky-300/20 card-hover-sky"
            >
              <div className="w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl">💰</span>
              </div>
              <h3 className="text-xl font-bold mb-2 text-sky-200">{t('highEarnings')}</h3>
              <p className="text-sky-100/70">{t('highEarningsDesc')}</p>
            </motion.div>
            ...
            <motion.div
              ...
              className="glass-effect p-6 rounded-lg border border-sky-300/20 card-hover-sky"
            >
              <div className="w-12 h-12 bg-gradient-to-r from-sky-500 to-cyan-500 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl">🚀</span>
              </div>
              <h3 className="text-xl font-bold mb-2 text-sky-200">{t('quickStart')}</h3>
              <p className="text-sky-100/70">{t('quickStartDesc')}</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-2 text-sky-200">{t('welcomeBonus')}</h3>
              <p className="text-sky-100/70">{t('welcomeBonusDesc')}</p>
            </motion.div>
          </div>
        </motion.div>
      </section>
      ...
      <section className="container mx-auto px-4 py-16">
        <motion.div
          ...
          className="text-center glass-effect p-8 rounded-lg border border-sky-300/20"
        >
          <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-sky-400 to-red-400 mb-4">
            {t('readyToStart')}
          </h2>
          <p className="text-sky-100/80 text-lg mb-6">
            {t('readyToStartDesc')}
          </p>
          <Button
            onClick={() => navigate('/register')}
...
const ProtectedRoute = ({ children, adminOnly = false }) => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-sky-700 via-sky-800 to-sky-900">
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-sky-700 via-sky-800 to-sky-900">
        <div className="text-center">
          ...
          <p className="text-sky-200">{t('loading')}</p>
        </div>
      </div>
    );
  }
